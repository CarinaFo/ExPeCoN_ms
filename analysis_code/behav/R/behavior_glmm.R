...
if (expecon == 1) {
  cue_model_path = file.path("data", "behav", "mixed_models", "cue_prev_int_model_signal_expecon1.rda")
  saveRDS(cue_prev_int_model_signal, cue_model_path)
  cue_prev_model <- readRDS(cue_model_path)
} else {
  cue_model_path = file.path("data", "behav", "mixed_models", "cue_prev_int_model_signal_expecon2.rda")
  saveRDS(cue_prev_int_model_signal, cue_model_path)
  cue_prev_model <- readRDS(cue_model_path)
}
...
if (expecon == 1) {
  cue_model_path = file.path("data", "behav", "mixed_models", "cue_prev_int_model_noise_expecon1.rda")
  saveRDS(cue_prev_int_model_noise, cue_model_path)
  cue_prev_model <- readRDS(cue_model_path)
} else {
  cue_model_path = file.path("data", "behav", "mixed_models", "cue_prev_int_model_noise_expecon2.rda")
  saveRDS(cue_prev_int_model_noise, cue_model_path)
  cue_prev_model <- readRDS(cue_model_path)
}
...
if (expecon == 1) {
  cue_model_path = file.path("data", "behav", "mixed_models", "cue_prev_int_model_conf_expecon1.rda")
  saveRDS(cue_prev_int_model_conf, cue_model_path)
  cue_prev_model <- readRDS(cue_model_path)
} else {
  cue_model_path = file.path("data", "behav", "mixed_models", "cue_prev_int_model_conf_expecon2.rda")
  saveRDS(cue_prev_int_model_conf, cue_model_path)
  cue_prev_model <- readRDS(cue_model_path)
}
...
if (expecon == 1) {
  cue_model_path = file.path("data", "behav", "mixed_models", "cue_prev_int_model_unconf_expecon1.rda")
  saveRDS(cue_prev_int_model_unconf, cue_model_path)
  cue_prev_model <- readRDS(cue_model_path)
} else {
  cue_model_path = file.path("data", "behav", "mixed_models", "cue_prev_int_model_unconf_expecon2.rda")
  saveRDS(cue_prev_int_model_unconf, cue_model_path)
  cue_prev_model <- readRDS(cue_model_path)
}
############################## Unused functions ###################################################
...
########################### confidence as dependen variable ########################################
