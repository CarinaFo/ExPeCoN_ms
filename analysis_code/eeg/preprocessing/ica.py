...
def label_icalabel():
    ...
    Output: cleaned epochs after ICA component rejection, CSV file containing the ICA labels marked as 
    non-brain from icalabel
    """
    ...
    for i in IDlist:
        ...
        # save the clean data
        epochs.save('P' + i + '_epochs_after_ic-label-epo.fif')
