...
nt_detection = count_resp([exp_data.intensity(exp_data.resp1_btn~=0) exp_data.resp1(exp_data.resp1_btn~=0)]);
...
disp(['Not responded (yes/no) in ' num2str(sum(exp_data.resp1_btn==0)) ' of ' num2str(length(exp_data.resp1_btn)) ' trials.'])