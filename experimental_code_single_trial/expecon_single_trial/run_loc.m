...
% run_loc(s,ao,ai,ID,PF_params,seq) starts the experiment.
% applies supra threshold stimuli with a random inter trial interval
% that is set in s.localizer_isi
