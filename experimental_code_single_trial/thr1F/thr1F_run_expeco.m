function data = thr1F_run(thr1F,aio_s,trig_s,ID)
...
% s.resp1_offset = 10
% 
% resp_rect1 = [data.window(1)*0.5 - s.resp1_offset - thr1F.txt_size,...
%               data.window(2)*0.5 - thr1F.txt_size,...
%               data.window(1)*0.5 - s.resp1_offset,...
%               data.window(2)*0.5 + thr1F.txt_size];
% resp_rect2 = [data.window(1)*0.5 + s.resp1_offset,...
%               data.window(2)*0.5 - thr1F.txt_size,...
%               data.window(1)*0.5 + s.resp1_offset + thr1F.txt_size,...
%               data.window(2)*0.5 + thr1F.txt_size];
% 
...
for i = 1:size(data.seq,1);
    ...
    % Buffer waveform
    stop(aio_s); %S2 trigger
    queueOutputData(aio_s,[data.stim_wave*data.intensity(i,1) data.stim_wave*0 data.stim_wave*0  data.TTL_wave]);       
