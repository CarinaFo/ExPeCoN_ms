...
ggsave('model_brain_behavior_new.svg', dpi = 300, height = 8, width = 10, plot=intg)
...
g_alpha = arrangeGrob(alpha_1, alpha_2, alpha_int_1, alpha_int_2, 
                nrow = 2)
# save figure
ggsave('brain_behavior_model_interactions_new.svg', dpi = 300, height = 8, width = 10, plot=g)
ggsave('brain_behavior_model_interactions_alpha_new.svg', dpi = 300, height = 8, width = 10, plot=g_alpha)