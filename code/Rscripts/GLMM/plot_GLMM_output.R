...
cue_model_path = file.path("data", "behav", "mixed_models", filename)
alpha_glm_1 <- readRDS(cue_model_path)
...
filename = paste("alpha_glm_", expecon, ".rda", sep="")
cue_model_path = file.path("data", "behav", "mixed_models", filename)
alpha_glm_2 <- readRDS(cue_model_path)

filename = paste("beta_glm_", expecon, ".rda", sep="")
cue_model_path = file.path("data", "behav", "mixed_models", filename)
beta_glm_2 <- readRDS(cue_model_path)
...
save_path_figs = file.path("figs", "manuscript_figures", "fig5_brain_behav")
...
# change the order of predictors (x and label)
beta_1 = plot_model(beta_int_glm_1, type='pred',terms = c("pre_beta", 'isyes'))
beta_2 = plot_model(beta_int_glm_2, type='pred', terms = c("pre_beta", "isyes"))
beta_int_1 = plot_model(beta_int_glm_1, type='pred',terms = c("pre_beta", 'prevresp'))
beta_int_2 = plot_model(beta_int_glm_2, type='pred', terms = c("pre_beta", "prevresp"))


alpha_1 = plot_model(alpha_int_glm_1, type='pred',terms = c("pre_alpha", 'isyes'))
alpha_2 = plot_model(alpha_int_glm_2, type='pred', terms = c("pre_alpha", "isyes"))
alpha_int_1 = plot_model(alpha_int_glm_1, type='pred',terms = c("pre_alpha", 'prevresp'))
alpha_int_2 = plot_model(alpha_int_glm_2, type='pred', terms = c("pre_alpha", "prevresp"))
...
g_alpha = arrangeGrob(alpha_1, alpha_2, alpha_int_1, alpha_int_2, 
                nrow = 2)
# save figure
ggsave('brain_behavior_model_interactions.svg', dpi = 300, height = 8, width = 10, plot=g)
